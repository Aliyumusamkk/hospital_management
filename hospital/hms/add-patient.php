...
<form role="form" name="" method="post">
	...
	<div class="form-group">
		...
		<input type="text" id="patreg" name="patreg" class="form-control"  placeholder="Enter Card No." required="true" maxlength="16" onBlur="userAvailability()">
		<span id="user-availability-status1" style="font-size:12px;"></span>
	</div>

	<div class="form-group">
		<label for="fess">Ward</label>
		<input type="text" name="patdept" class="form-control"  placeholder="Enter Patient Ward" required="true" maxlength="40">
	</div>
