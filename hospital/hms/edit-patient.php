...
<div class="form-group">
		<label for="fess">Card No.</label>
		<input type="text" name="patreg" class="form-control"  value="<?php  echo $row['PatientReg'];?>" placeholder="Enter Patient Card No." required="true" maxlength="16" readonly>
</div>
<div class="form-group">
...
<div class="form-group">
		<label for="fess">Ward</label>
		<input type="text" name="patdept" class="form-control"  value="<?php  echo $row['PatientDept'];?>" placeholder="Enter Patient Ward" required="true" maxlength="30">
</div>
<div class="form-group">
